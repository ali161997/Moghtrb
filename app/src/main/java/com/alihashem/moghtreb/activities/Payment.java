...
public class Payment extends AppCompatActivity implements View.OnClickListener {
    ...
    private MutableLiveData<String> indexNotification = new MutableLiveData<>();
    ...
    private void uploadConfirmation() {
        ...
        FirebaseFirestore.getInstance().collection("Requests").document()
                .set(request)
                .addOnSuccessListener(aVoid -> {
                    //completed.setValue(true);
                })
                .addOnFailureListener(e -> Log.i(TAG, "uploadConfirmation: fail"));
