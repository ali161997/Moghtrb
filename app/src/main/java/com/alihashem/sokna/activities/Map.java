...
//        }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(() -> {
            add_Marker_des(assiut_latlng, "service exists in assiut");
        }, 3000);
    ...
    private void add_Marker_des(LatLng latLng, String name) {
    ...
    public void recyclerViewListClicked(View v, int position) {
        ...
        intent.putExtra("room_selected", mapViewModel.getListRooms().getValue().get(position).getRoomId());
                ...
                .addOnSuccessListener(getActivity(), location -> {
                    ...
                    if (location != null) {
                        ...
                        try {
                            ...
                            add_Marker(new LatLng(location.getLatitude(), location.getLongitude()), addresses.get(0).getAddressLine(0));
