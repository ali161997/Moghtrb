...
public class Uploading_explore {
    ...
    private static Search search_result = new Search();
    ...
    public void setSearch_result(MutableLiveData<Search> searchMutableLiveData) {
        search_result = searchMutableLiveData.getValue();
        perform_opload();
    }
    ...
    private void perform_opload() {
        db.collection("users")
                ...
                .document("search1").set(search_result)
    ...
    public void settoUpload() {
       /* ArrayList<String>imgs=new ArrayList<>();
        ...
        Room room1=new Room(400.0,3,100,"assiut-asyut-seed factoty-shehab street",2,"Comfortable",
                imgs);
        roomSet.add(room1);
        roomSet.add(room1);
        roomSet.add(room1);
