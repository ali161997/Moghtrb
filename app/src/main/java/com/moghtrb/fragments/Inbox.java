...
import com.moghtrb.activities.Payment;
import com.moghtrb.adapters.NotificationAdapter;
import com.moghtrb.models.VerticalSpaceItemDecoration;
import com.moghtrb.viewmodels.InboxViewModel;
...
public class Inbox extends Fragment implements View.OnClickListener,
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        inboxViewModel.getStayRefreshing().observe(getViewLifecycleOwner(), bool -> {
            if (!bool) {
