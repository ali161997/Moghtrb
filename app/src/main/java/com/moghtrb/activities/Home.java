...
import com.moghtrb.fragments.Map;
import com.moghtrb.fragments.More;
import com.moghtrb.fragments.Services;
import com.moghtrb.repositories.explore_Repository;
import com.moghtrb.viewmodels.HomeViewModel;
...
public class Home extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    private BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            badgeDrawable.setBackgroundColor(R.color.blue);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.services_id:
                viewFragment(new Services(), "Fragment_other");
                viewModel.setFragment_Selected(new Services());
                return true;
